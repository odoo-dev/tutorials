...
class SubProductWizard(models.TransientModel):
    ...
    def default_get(self, fields_list):
        ...
        if main_order_line.sub_line_ids:
            for record in main_order_line.sub_line_ids:
    ...
    def action_add_products(self):
        ...
        existing_products = { line.product_id.id: line for line in main_order_line.sub_line_ids }
