...
class Sign(Sign):
    ...
    def get_document_qweb_context(self, sign_request_id, token, **post):
        # Get the base context from the parent class method
