...
patch(OrderReceipt.prototype, {
    ...
    get tax_details(){
        return this.order.get_tax_details()
    },
    ...
    lineData(line, lineIndex) {
        return {
            ...
            name: {
                class: "product-name",
                value: line?.orderDisplayProductName?.name || line.product_id.name,
            ...
            price: { class: "product-price price", value: this.formatCurrency(line.getTotalString())},
        };
    },
    ...
    _getPreviewOrderData() {
        const _getPreviewOrderLine = (product, index) => {
            ...
            return {
                ...
                getTotalString: () => (qty * product.list_price),
